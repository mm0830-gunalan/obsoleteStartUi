		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#obsolerteworkflowworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"obsolerteworkflowworkflowuimodule-display": {
								"semanticObject": "obsolerteworkflowworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=obsolerteworkflow.workflowuimodule",
									"url": sap.ui.require.toUrl("obsolerteworkflow/workflowuimodule")
								}
							}
						}
					}
